...
(define (compute-length get-line-segment get-start-point get-end-point)
  (let* ((line (get-line-segment)) (first-line (get-start-point line)) (last-line (get-end-point line)) (x1 (car first-line)) (y1 (cdr first-line))   (x2 (car last-line)) (y2 (cdr last-line)))



    (expt (+(*(- x2 x1)(- x2 x1) )(*(- y2 y1)(- y2 y1) )) (/ 1 2))))
